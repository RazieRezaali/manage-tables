...
<body>
	<form action="<?php echo base_url() ?>main/insertNewRecord2/" method="post">
		<?php
			foreach($fields as $row){
				...
				echo '   <input type="text" name="'.$row['Field'].'" value="'.set_value($row['Field']).'">';
		...
		?>
		<input id="sub" type="submit" value="insert" name="submit">
	</form>
